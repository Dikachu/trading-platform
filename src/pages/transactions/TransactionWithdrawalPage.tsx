...
import { withdrawalTransactions } from "@/data/transactions";
...
export function TransactionWithdrawalPage() {
  const [searchQuery, setSearchQuery] = useState("");
  const [showExportMenu, setShowExportMenu] = useState(false);

  const handleExport = (format: "csv" | "json") => {
    if (format === "csv") {
      exportToCSV(withdrawalTransactions, "withdrawals");
    } else {
      exportToJSON(withdrawalTransactions, "withdrawals");
    }
