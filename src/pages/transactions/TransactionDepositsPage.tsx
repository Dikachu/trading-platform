...
import { depositTransactions } from "@/data/transactions";
...
export function TransactionDepositsPage() {
  const [searchQuery, setSearchQuery] = useState("");
  const [showExportMenu, setShowExportMenu] = useState(false);

  const handleExport = (format: "csv" | "json") => {
    if (format === "csv") {
      exportToCSV(depositTransactions, "deposits");
    } else {
      exportToJSON(depositTransactions, "deposits");
    }
